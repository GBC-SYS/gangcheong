...
```css
/* 인트로/버튼용 그라데이션 */
--gradient-primary: linear-gradient(135deg, #e91e63 0%, #ff5722 50%, #ff9800 100%);

/* 프로그레스 바용 */
--gradient-progress: linear-gradient(90deg, #e91e63 0%, #f44336 25%, #ff9800 50%, #ffeb3b 75%, #4caf50 100%);
```
